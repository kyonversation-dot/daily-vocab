...
- **語彙チャレンジ**（60秒でカードめくり）／**語彙マッチング**（言葉↔意味を結ぶ）／**🔤よみ三択**／**🧠いみ三択**。
  - **★三択2つは「これまでに出会った語ぜんぶ」から出る**＝単元の新出を出し切ったあとも、同じ語が別の問題として何回でも回る（2026-08-13キヨ「今やっている単元を何回もまわしてよい。チェックするだけでなくクイズ形に」）。
  - いみ三択は**答えの語を意味文の中から伏せる**（◯◯）＝読まずに当たらないようにしてある。
